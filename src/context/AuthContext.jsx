...
// Backendda rol email/parolga emas, hisobga bog'liq bo'ladi — mockda buni email orqali simulyatsiya qilamiz:
// "admin@..." bilan kirilsa admin, "seller@..." bilan kirilsa sotuvchi, aks holda oddiy foydalanuvchi.
...
export function AuthProvider({ children }) {
  ...
  async function login({ email, password }) {
    ...
    setUser({ ...mockUser, email, role: resolveMockRole(email) })
    return { success: true }
  }
